		...
		<div className="team-card-cell">
			<div className="team-card">
				<div className="team-card__inner">
					<div className="team-card__spectacle" aria-hidden>
						<div
							className="team-card__logo-bg"
							style={{ backgroundImage: `url(${item.logo})` }}
						/>
						<div className="team-card__spectacle-scene">
							<div className="team-card__logo-stage">
								<img src={item.logo} alt="" />
								<div className="team-card__spectacle-veil" />
							</div>
						</div>
						<div className="team-card__spectacle-caption">
							<span className="team-card__spectacle-name">{item.teamName}</span>
						</div>
					</div>
						...
						<div className="team-card__body">
							<div className="team-card__row">
								...
								<span>
									...
									<span className="team-card__value">{item.city}</span>
								</span>
							</div>
							<div className="team-card__row">
								<UserOutlined />
								<span>
									...
									<span className="team-card__value">{item.manager}</span>
								</span>
							</div>
							<div className="team-card__row">
								<HomeOutlined />
								<span>
									...
									<span className="team-card__value team-card__value--arena">{item.homeArena}</span>
								</span>
							</div>
						</div>
					</div>
